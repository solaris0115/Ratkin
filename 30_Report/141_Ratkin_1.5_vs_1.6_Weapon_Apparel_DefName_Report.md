...
재현 스크립트: `90_Tools/diff_weapon_apparel_15_16.py` (실행 시 `90_Tools/weapon_apparel_15_16_report.md`도 갱신됨)
...
python 90_Tools\diff_weapon_apparel_15_16.py
```

갱신 산출물: `90_Tools/weapon_apparel_15_16_report.md` (본 보고서와 동일 데이터의 간단 복제)
