...
- 별도 `coverGrid` 등록/해제 없이, **Job/Comp로 회전만 고정**하면 매 발사의 `ShotReport`에서 동일 조건으로 판정 가능 (`./Shield_FaceDirection_Command_Analysis.md` 등과 연계 검토).
...
- `./Shield_FaceDirection_Command_Analysis.md` — 방패 방향·커맨드
- `./130_RK_TowerShield_v2_Armor_Deflection_Formula_Report.md` — 방패 방어/편향 수식
- `./128_Ratkin_Shield_Deflection_Logic_1.5_Analysis_Report.md` — 방패 편향 로직
