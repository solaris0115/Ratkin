...
1. **압축**: Project/ 폴더를 ZIP으로 패키징
2. **1.5 제외**: Project/1.5/ 압축에서 제외
3. **웹 배포**: GitHub Release 업로드 (기본: solaris0115/NewRatkin)
...
| 출력 DLL | Project/1.6/Assemblies/NewRatkin.dll |
| 중간 출력 | Project/1.6/Source/obj/Debug/ |
